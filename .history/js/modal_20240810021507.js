function modal(mensagemFormularioEnviado) {
    const elementos = {
    ...
    const abrirModal = document.querySelectorAll(elementos.abrirModal) || mensagemFormularioEnviado;
    const tipoModal = document.querySelectorAll(elementos.tipoModal);
    console.log(mensagemFormularioEnviado.dataset.mensagem);
    ...
    function ativarModal(botao, modal, ultimoBotaoAtivo) {
        const botaoClicado = botao.dataset.abrirModal || botao.dataset.mensagem;
