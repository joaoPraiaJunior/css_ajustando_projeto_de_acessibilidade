function modal(botaoMensamDeEnvio) {
    const elementos = {
    ...
    if (botaoMensamDeEnvio) {
        abrirModal = botaoMensamDeEnvio;
    } else {
        abrirModal = document.querySelectorAll(elementos.abrirModal);
    }
    console.log(abrirModal.dataset);
    ...
    function ativarModal(botao, modal, ultimoBotaoAtivo) {
        const botaoClicado = botao.dataset.abrirModal || botao.dataset.botaoMensagem;
