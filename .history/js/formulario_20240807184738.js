...
function formulario() {
    ...
    function validaCampo(campo) {
       let mensagemDeErroCustomizada = '';
        ...
        if(!validadorDeInput) {
            mensagemDeErroCustomizada = mensagemDeErroDoCampo(campo, mensagemDeErroCustomizada);
        } else {
    ...
    function mensagemDeErroDoCampo(mensagemDeErroCustomizada) {
        const mensagemDeErro = campo.nextElementSibling;
        mensagemDeErro.innerText = mensagemDeErroCustomizada;
    }
}
