...
function formulario() {
    ...
    function validaCampo(campo) {
        ...
        const elementoMensagemDeErro = document.querySelectorAll('[data-js="mensagem"]');

        while(elementoMensagemDeErro.dataset.js !== 'mensagem') {
            elementoMensagemDeErro = campo.parentElement
        }
