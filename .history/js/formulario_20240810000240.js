...
function formulario() {
    ...
    function mensagemDeEnvio(formulario) {
        const tipoDeFormulario = formulario.dataset.tipoFormulario;
        const eventoDoFormulario = new Event('enviado', {
            detail: {
        ...
        return document.dispatchEvent(eventoDoFormulario);
    }
