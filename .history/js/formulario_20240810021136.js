...
function formulario() {
    ...
    const elementos = {
        ...
        mensagemFormularioEnviado: '[data-mensagem="mensagem-formulario-enviado"]'
    }
    ...
    function enviarFormulario(formulario) {
        const mensagemFormularioEnviado = formulario.querySelectorAll(elementos.mensagemFormularioEnviado);
        formulario.addEventListener('submit', (evento) => {
            ...
            if (formulario.checkValidity()) {
                ...
                formulario.reset();
                modal(mensagemFormularioEnviado)
            }
        });
    }
