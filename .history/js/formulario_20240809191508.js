...
function formulario() {
    ...
    function enviarFormulario(formulario) {
        ...
        formulario.addEventListener('submit', (evento) => {
            ...
            if(formulario.checkValidity()) {
                pegarDadosDoFormulario(formulario, camposDoFormulario, dadosDeUsuarios);
                formulario.submit();
            }
        });
    ...
    function pegarDadosDoFormulario(formulario, camposDoFormulario, dadosDeUsuarios) {
        ...
        localStorage.setItem(`${formulario}`, JSON.stringify(dadosDeUsuarios));
    }
