...
function formulario() {
    ...
    const elementos = {
        ...
        botaoMensagemDeEnvio: '[data-botao-mensagem="mensagem-formulario-enviado"]',
    }
    ...
    function enviarFormulario(formulario) {
        const botaoMensagemDeEnvio = formulario.querySelectorAll(elementos.botaoMensagemDeEnvio);
